...
/**
 * gaia_sludge_girl - cybercat5555 Created using Tabula 7.1.0
 */
public class ModelSludgeSlimeGirl extends ModelGoGRBase {
    ...
    public ModelSludgeSlimeGirl(boolean slime) {
        this.slime = slime;
        ...
        this.lArmBones.setRotationPoint(5.0F, 2.4F, 0.0F);
        this.lArmBones.addBox(-0.5F, -2.0F, -1.0F, 2, 12, 2, 0.0F);
        this.setRotateAngle(lArmBones, -0.0F, 0.0F, -0.10000736613927509F);
        ...
        if(slime) {
            ...
            this.ribs.addChild(this.lLegBones);
            this.ribs.addChild(this.rArmBones);
            this.ribs.addChild(this.rLegBones);
            this.ribs.addChild(this.skull);
            this.ribs.addChild(this.lArmBones);
        }
    }
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        lLegBones.rotateAngleY = BipedLeftLeg.rotateAngleY;
        rLegBones.rotateAngleZ = BipedRightLeg.rotateAngleZ;
        lLegBones.rotateAngleZ = BipedLeftLeg.rotateAngleZ;

        rArmBones.rotateAngleX = BipedRightArm.rotateAngleX;
        lArmBones.rotateAngleX = BipedLeftArm.rotateAngleX;
        rArmBones.rotateAngleY = BipedRightArm.rotateAngleY;
        lArmBones.rotateAngleY = BipedLeftArm.rotateAngleY;
        rArmBones.rotateAngleZ = BipedRightArm.rotateAngleZ;
        lArmBones.rotateAngleZ = BipedLeftArm.rotateAngleZ;
    }
