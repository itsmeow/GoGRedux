...
/**
 * gaia_anubis_male - cybercat5555
 * Created using Tabula 7.0.1
 */
public class ModelAnubisMale extends ModelBase {
    ...
    public ModelAnubisMale() {
        ...
        this.headpieceBack = new ModelRenderer(this, 42, 51);
        this.headpieceBack.setRotationPoint(0.0F, -6.2F, 2.2F);
        this.headpieceBack.addBox(-4.0F, -0.7F, -1.9F, 8, 10, 3, 0.0F);
        ...
        this.headpieceLeft = new ModelRenderer(this, 31, 52);
        this.headpieceLeft.setRotationPoint(2.4F, -4.5F, -0.9F);
        this.headpieceLeft.addBox(-0.5F, -0.7F, -1.5F, 2, 9, 3, 0.0F);
        this.setRotateAngle(headpieceLeft, -0.2617993877991494F, 0.0F, -0.08726646259971647F);
        ...
        this.BipedHead.addBox(-3.5F, -7.0F, -4.0F, 7, 7, 7, 0.0F);
        ...
        this.headpieceRight = new ModelRenderer(this, 31, 52);
        this.headpieceRight.mirror = true;
        this.headpieceRight.setRotationPoint(-2.4F, -4.5F, -0.9F);
        this.headpieceRight.addBox(-1.5F, -0.7F, -1.5F, 2, 9, 3, 0.0F);
        this.setRotateAngle(headpieceRight, -0.2617993877991494F, 0.0F, 0.08726646259971647F);
        this.BipedRightArm.addChild(this.rightShoulderPad);
        this.BipedHead.addChild(this.lEar01);
        this.BipedHead.addChild(this.headpieceBack);
        this.lEar01.addChild(this.lEar02);
        this.BipedHead.addChild(this.headpieceLeft);
        ...
        this.BipedHead.addChild(this.muzzleRight);
        ...
        this.BipedHead.addChild(this.muzzleLeft);
        this.BipedHead.addChild(this.lowerJaw);
        this.BipedBody.addChild(this.BipedRightArm);
        this.BipedBody.addChild(this.rightPec);
        this.BipedHead.addChild(this.headpieceRight);
    }

    @Override
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        this.BipedBody.render(f5);
        this.rEar01.render(f5);
    }
